...
module.exports = function (content) {
  ...
  var mpOptions = loaderUtils.getOptions(this) || {}
  ...
  /**
   * @markdown
   * 用 mpvue-template-compiler 编译 components
   * js || css(还是wxss?) || html 对应
   * parts.script || parts.styles || parts.template
   * */
  ...
  var babelLoaderOptions = mpOptions.globalBabelrc ? {
    loader: 'babel-loader',
    options: {
